      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Your trusted pharmacy partner. Delivering genuine medicines,
            healthcare essentials, and wellness products at your doorstep.
          </p>
          {/* App Links */}
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/diagnostics" className="hover:text-white">Diagnostics</Link></li>
            <li><Link href="/devices" className="hover:text-white">Healthcare Devices</Link></li>
          </ul>
        </div>
