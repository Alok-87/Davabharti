  ...
  return (
    <div className="bg-gray-50 rounded-md">
      <div>
        ...
        <main className="mx-auto  max-w-2xl px-4 mt-5 sm:px-6  lg:max-w-7xl lg:px-8">
          <div className=" lg:grid lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4  ">
            <aside>
              ...
              <div className="hidden lg:block">
                <form className="divide-y divide-gray-200 p-5">
                  {filters.map((section) => (
                    <div key={section.name} className="py-2 first:pt-0 last:pb-0">
                      <fieldset>
