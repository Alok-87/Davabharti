...
import { setShowOfferModal, setShowSidebarOpen } from "@/features/user-profile/userProfileSlice";
...
export default function OfferStrip() {
    ...
    // find the offer that should show on home
      ...
      ">
        ...
        ">
                    ...
                    <p className="flex-1 text-sm md:text-base font-medium whitespace-nowrap overflow-hidden">
                        {homeOffer?.discountType}{homeOffer?.discountValue} + {homeOffer?.description} | Limited Time Offer
                    </p>
