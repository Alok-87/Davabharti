...
import WhyChooseUsCarousel from './WhyChooseUsCarousel'; // path adjust
  ...
  return (
    <section className="py-12 bg-white sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        {/* Mobile Carousel */}
        <WhyChooseUsCarousel features={features} />

        {/* Desktop Grid */}
        <div className="hidden md:grid md:grid-cols-3 md:mt-12">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 text-base text-gray-600 leading-relaxed text-center">
                  {feature.desc}
                </p>
              </div>
            );
