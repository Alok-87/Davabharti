...
const PRODUCTS = [
  { id: 1, name: "Face cream", price: 100, description: "Orange & Aloe Vera", image: "https://pagedone.io/asset/uploads/1700726158.png" },
  { id: 2, name: "Plastic bottle", price: 40, description: "Black color", image: "https://pagedone.io/asset/uploads/1700726174.png" },
  { id: 3, name: "Men cream", price: 100, description: "Aloe Vera and Neem", image: "https://pagedone.io/asset/uploads/1700726191.png" },
  { id: 4, name: "Cold Perfume", price: 100, description: "White perfume", image: "https://pagedone.io/asset/uploads/1700726207.png" },
    { id: 5, name: "Luxury Soap", price: 20, description: "Lavender fragrance", image: "https://pagedone.io/asset/uploads/1700726210.png" },
  { id: 6, name: "Hair Oil", price: 15, description: "Coconut & Almond", image: "https://pagedone.io/asset/uploads/1700726222.png" },
  { id: 7, name: "Shampoo", price: 25, description: "Herbal extracts", image: "https://pagedone.io/asset/uploads/1700726234.png" },
  { id: 8, name: "Body Lotion", price: 30, description: "Moisturizing Aloe", image: "https://pagedone.io/asset/uploads/1700726248.png" },
];

export const metadata: Metadata = {
  title: "MedShop — Buy Medicines & Health Products Online",
  description: "Order medicines, healthcare products, and book consultations. Fast delivery and verified sellers.",
};
