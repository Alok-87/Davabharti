...
export default function FeatureMobileCarouselClient() {
  ...
  return (
    ...
    <div
      className="relative md:hidden w-full mt-6 overflow-hidden"
    ...
    >
      ...
      <button
        onClick={prev}
        aria-label="Previous"
        className="absolute left-2 top-1/2 -translate-y-1/2 text-gray-600 text-3xl z-10"
      >
        <BiLeftArrow />
      </button>
      <button
        onClick={next}
        aria-label="Next"
        className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 text-3xl z-10"
      >
        <BiRightArrow />
      </button>
    </div>
